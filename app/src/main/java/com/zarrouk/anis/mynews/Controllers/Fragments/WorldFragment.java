...
import com.zarrouk.anis.mynews.Adapters.WorldAdapter;
 ...
 */
public class WorldFragment extends BaseFragment implements MyAsyncTask.Listeners {
    @BindView(R.id.list)
    RecyclerView rv;
    List<News> myNews;
    ...
    protected void configureDesign() {
        ...
        rv.setAdapter(new WorldAdapter(myNews));
        this.startAsyncTask();
    }
